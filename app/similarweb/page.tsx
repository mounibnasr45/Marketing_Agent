      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h1 className="text-3xl font-bold">SimilarWeb Analysis</h1>
          </div>
          <p className="text-muted-foreground">
            Analyze website traffic, rankings, and audience insights
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Enter a domain name to analyze traffic data and insights
            </CardDescription>
          </CardHeader>
          <CardContent>
